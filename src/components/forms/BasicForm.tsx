import { Flex, Text, Switch, Box, FormControl, FormLabel, Input, Button } from '@chakra-ui/react';
        ...
        <Flex flexDir={'column'} gap={'24px'}>
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                width="350px"
                height="50px"
                border={errors.email || isEmailExisted ? '1px solid red' : '1px solid #E2E8F0'}
                borderRadius="15px"
                mt="4px"
                type="email"
                {...register('email')}
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                border={errors.repeat_password ? '1px solid red' : '1px solid #E2E8F0'}
                width="350px"
                height="50px"
                borderRadius="15px"
                mt="4px"
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                border={errors.social?.facebook ? '1px solid red' : '1px solid #E2E8F0'}
                width="350px"
                height="50px"
                borderRadius="15px"
                mt="4px"
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                border={errors.social?.linkedIn ? '1px solid red' : '1px solid #E2E8F0'}
                width="350px"
                height="50px"
                borderRadius="15px"
                mt="4px"
            ...
            {errors.social?.linkedIn && <ErrorMess error={errors.social?.linkedIn.message} />}
          </Flex>
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            ...
            {errors.social?.linkedIn && <ErrorMess error={errors.age?.message} />}
          </Flex>
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            ...
            {errors.social?.linkedIn && <ErrorMess error={errors.dob?.message} />}
          </Flex>
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                border={errors.phoneNums?.[0] ? '1px solid red' : '1px solid #E2E8F0'}
                width="350px"
                height="50px"
                borderRadius="15px"
                mt="4px"
          ...
          <Flex flexDir={'column'} gap={'5px'}>
            <Flex flexDir={'column'}>
              ...
              <Input
                border={errors.phoneNums?.[1] ? '1px solid red' : '1px solid #E2E8F0'}
                width="350px"
                height="50px"
                borderRadius="15px"
                mt="4px"
            ...
            <Flex flexDir={'column'}>
              ...
              <Flex flexDir={'column'} gap={'8px'}>
                {fields.map((field, index) => (
                  <Flex key={field.id} justifyContent={'center'} align={'center'} gap={'10px'}>
                    <Input
                      border={
                        errors.phNums?.[index]?.pNumber ? '1px solid red' : '1px solid #E2E8F0'
                      }
                      width="350px"
                      height="50px"
                      borderRadius="15px"
                      ...
                      p="0 20px 0 20px"
                    />
                    <ErrorMess error={errors.phNums?.[index]?.pNumber?.message}></ErrorMess>
                    {index > 0 && (
                      <Button
                        type="button"
                        onClick={() => {
                ...
                <Button
                  ...
                  minH="45px"
                >
                  <Text color="#FFFFFF" fontSize="15px" fontWeight={'800'}>
          ...
          <FormControl display="flex" alignItems="center" gap="10px">
            ...
            <FormLabel htmlFor="rememer-me-switch" mb="0" fontSize="12px" color="#2D3748">
              Remember me
            </FormLabel>
          </FormControl>
