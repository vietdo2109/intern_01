...
export default function SignUp() {
  ...
  const iconBg = '#2D3748';
  return (
    <Flex as="nav" p={'10px'} w={'100%'} justifyContent={'center'} h={'100vh'} mb={'20px'}>
      <Flex
        w={'100%'}
        alignItems="center"
        borderRadius={'15px'}
      ...
      >
        ...
        >
          ...
          <Box>
            <Text fontSize="14px" fontWeight="400" color="white" textAlign="center">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            ...
            <Flex flexDir="column" alignItems="center" justifyContent="center">
              <Text fontFamily={'Helvetica'} fontWeight="700" fontSize="18px" color="#2D3748">
                Register with
              </Text>
              <Flex minW="255px" gap="15px" p="25px">
                ...
                >
                  <Link to={'/'}>
                    <Icon w="26px" h="26px" color={iconBg} mt="5px" as={FaFacebook}></Icon>
                  </Link>
                </Flex>
                <Flex
                  w="75px"
                ...
                >
                  <Link to={'/'}>
                    <Icon w="31px" h="31px" color={iconBg} as={FaApple}></Icon>
                  </Link>
                </Flex>
                <Flex
                  w="75px"
                ...
                >
                  <Link to={'/'}>
                    <Icon w="24px" h="24px" mt="5px" color={iconBg} as={FaGoogle}></Icon>
                  </Link>
                </Flex>
              </Flex>
            ...
            <Flex flexDir={'column'} gap="26px" mt="10px">
              <Box>
                <Text fontSize="14px" color={iconBg} ml="5px">
                  Name
                </Text>
                <Input
                  width="350px"
              ...
              <Button bg="#4FD1C5" size="lg" borderRadius="12px" mt="14px" type="submit">
