    ...
    <Layout>
      <Flex width="100%" minW="700px" zIndex={1} right={0} flexDir="column">
        <Flex flex="1" width="100%" padding="24px" minH={'350px'} gap={'24px'} flexDir={'column'}>
          ...
          <Flex gap={'24px'}>
            <Flex w={'60%'} h={'255px'} bg={WHITE_COLOR} padding={'17.5px'} borderRadius={'15px'}>
              <Flex flex={1} justifyContent={'space-between'}>
                <Flex w={'40%'} flexDir={'column'} justifyContent={'space-between'}>
                  ...
                  <Text color={DARK_COLOR} fontSize={'10px'} fontWeight={700} cursor="pointer">
                    Read more
                  </Text>
                </Flex>
                <Box
            ...
            <Flex w={'40%'} h={'255px'} bg={WHITE_COLOR} borderRadius={'15px'} padding={'17.5px'}>
              <Box
                bgImage={brookeCagle}
                bgSize="cover"
                bgPos={'center'}
              ...
              >
                ...
                >
                  ...
                  >
                    <Flex flexDir={'column'} gap={'3px'}>
                      <Text color={WHITE_COLOR} fontSize={'18px'} fontWeight={700}>
                        Purity UI Dashboard
                      </Text>
                      <Text color={WHITE_COLOR} fontSize={'14px'} fontWeight={400}>
                        From colors, cards, typography to complex elements, you will find the full
                        documentation.
                      </Text>
                    </Flex>
                    <Text color={WHITE_COLOR} fontSize={'10px'} fontWeight={700} cursor="pointer">
                      Read more
                    </Text>
                  </Flex>
                </Flex>
